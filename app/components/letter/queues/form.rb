    ...
    form_with(model: queue, url: form_url, scope: :letter_queue) do |f|
      ...
      div(class: "form-grid mb-3") do
        div(class: "mb-1") do
          ...
          input(type: :text, name: "letter_queue[name]", value: queue.name, required: true, class: "w-100")
        end
        div(class: "mb-1") do
          label(class: "label-block text-muted") { "Display Title" }
          input(type: :text, name: "letter_queue[user_facing_title]", value: queue.user_facing_title, class: "w-100")
      ...
      div(class: "form-field-lg") do
        ...
        input(type: :text, name: "letter_queue[letter_return_address_name]", value: queue.letter_return_address_name, class: "w-100")
      ...
      admin_tool do
        div(class: "form-field-lg") do
          ...
          input(type: :text, name: "letter_queue[slug]", value: queue.slug, class: "w-100")
        end
      end
